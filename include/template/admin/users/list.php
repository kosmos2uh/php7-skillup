                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <form method="post" action="<?php echo url('admin_users_delete', ['id' => $arUser['id']]); ?>">
                                    <button class="btn btn-xs btn-danger float-right delete-btn" type="submit" data-toggle="modal" data-target="#modal-delete-user" data-message="Удалить пользователя <b><?php echo $arUser['name']; ?></b> [<?php echo $arUser['email']; ?>]?"><i class="fas fa-trash"></i> удалить</button>
                                </form>
